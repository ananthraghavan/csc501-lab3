...
#define PRLOCK      '\011'      /* process is on lock queue*/
...
struct	pentry	{
	...
	int plock;                  /*id of lock waiting on */
	int lprio;                 /*waiting with prio lprio */
	int lstate;                /* waiting for READ or WRITE */
	unsigned long ltime;        /* cntr1000 at start of wait*/
	unsigned long lheld32;
	unsigned long lheld50;
	int lnosheld;
};
